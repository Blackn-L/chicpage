...
export function MobileExportPreview({
  ...
  const activePreviewScale = Math.min(
    0.82,
    300 / layout.width,
    420 / layout.height,
  );
    ...
    >
      <DrawerContent className="h-[92svh] max-h-[760px] overflow-hidden rounded-t-[28px] data-[vaul-drawer-direction=bottom]:max-h-[92svh]">
        ...
        <DrawerHeader className="shrink-0 px-4 pb-3 pt-4 text-left">
          ...
          <DrawerDescription>
            共 {slides.length} 页，确认后导出为 PNG 图片。
          </DrawerDescription>
        </DrawerHeader>
        ...
        {activeSlide ? (
          ...
          >
            <div
              className="relative my-auto max-w-full rounded-2xl bg-card p-3 shadow-2xl"
